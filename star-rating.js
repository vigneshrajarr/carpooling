    ...
    Rating.prototype = {
        ...
        listen: function () {
            ...
            self.$clear.on("mousemove", function () {
                ...
                var caption = '<span id=rating-value class="' + self.clearCaptionClass + '">' + self.clearCaption + '</span>',
        ...
        clear: function () {
            var self = this,
                title = '<span id=rating-value class="' + self.clearCaptionClass + '">' + self.clearCaption + '</span>';
